...
paper_key: "doi:10.1007/s00521-021-06397-6"
paper_type: review
year: 2024
...
related_tasks:
  - "[[Surface defect detection]]"
source_file: "paper-inbox/10_processed/2024 - Ameri - A Systematic Review of Deep Learning Approaches for Surface Defect Detection in Industrial Applications.pdf"
preprocessed_input: "paper-inbox/90_processing/analysis-inputs/2024 - Ameri - A Systematic Review of Deep Learning Approaches for Surface Defect Detection in Industrial Applications.md"
extracted_text: "paper-inbox/90_processing/text/2024 - Ameri - A Systematic Review of Deep Learning Approaches for Surface Defect Detection in Industrial Applications.txt"
...
- Systematic review of deep learning approaches for surface defect detection in industrial applications.
- Treats surface defect detection as an industrial visual inspection problem where deep learning methods are compared across application domains.
- Useful as a survey anchor for defect-detection methods, datasets, and application constraints.
...
- Claimed: Systematic review of deep learning approaches for surface defect detection in industrial applications.
- Shown: The title and extracted metadata identify the paper as a systematic review of deep learning approaches for surface defect detection in industrial applications.
- Inferred: This paper strengthens the vault's coverage of [[Surface defect detection]].

## Method

- Core idea: Systematic review of deep learning approaches for surface defect detection in industrial applications.
- Architecture / algorithm: [[Deep convolutional neural network]]
...
- Objective: Systematic review of deep learning approaches for surface defect detection in industrial applications.
...
- Data source: The title and extracted metadata identify the paper as a systematic review of deep learning approaches for surface defect detection in industrial applications.
...
- Performance metrics status: not applicable
...
|---|---|---|---|---:|---:|---|
| Contribution summary | [[Surface defect detection]] | not applicable | not reported | not reported | not reported | The title and extracted metadata identify the paper as a systematic review of deep learning approaches for surface defect detection in industrial applications. |

### Performance Metrics

| Metric | Used for | Definition / unit | Direction | Primary? | Notes |
|---|---|---|---|---|---|
| not applicable | paper evaluation or review synthesis | see linked notes when available | not reported | not reported | not reported in this concise pass |
...
- Source: The title and extracted metadata identify the paper as a systematic review of deep learning approaches for surface defect detection in industrial applications.
...
- Scope: Systematic review of deep learning approaches for surface defect detection in industrial applications..
- Inclusion criteria: not reported in this concise pass.
- Taxonomy: not reported in this concise pass.
- Major themes: [[Surface defect detection]]; [[Deep convolutional neural network]].
- Gaps: not reported in this concise pass.

## Limitations

- Stated: not reported in this concise pass.
- Inferred: Because this is a review paper, it does not introduce a new dataset or primary detector in the extracted metadata.
...
- Tasks: [[Surface defect detection]]
...
- [[Deep convolutional neural network]]: method family or named architecture linked from the paper's title, abstract, or keywords.
